...
for column in df.columns:
    ...
    results = gp.profile(organism='athaliana', user_threshold = '0.05', no_evidences=False,
                         query = gene_list)

    # write the results to a csv file
    results.to_csv(output_directory + experiment_name + '_gprofiler_0dot05.csv', sep='\t', index=False)

    # result to excel file
    results.to_excel(output_directory + experiment_name + '_gprofiler_0dot05.xlsx')
