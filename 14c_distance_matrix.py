...
cuff_in_dir = "/scratch/sah2p/datasets/2023_11_04_BurkeLab/output/8_cuffdiff_result/Cuffdiff"
...
distance_matrix_df = pd.DataFrame(distance_matrix(data.T, data.T), index=data.columns, columns=data.columns)
...
# # # Save the figure
plt.savefig(output_directory+'all_samples_heatmap.png', dpi=300)